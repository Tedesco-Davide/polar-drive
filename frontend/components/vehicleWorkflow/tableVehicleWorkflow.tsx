...
import AddFormVehicleWorkflow from "@/components/vehicleWorkflow/addFormVehicleWorkflow";
...
export default function TableVehicleWorkflow({ t }: { t: TFunction }) {
  ...
  }, [currentPage, query, fetchWorkflowData]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error(
          `[TableVehicleWorkflow] HTTP ${response.status}: ${responseText}`
        );
        try {
  ...
  return (
    ...
    >
      {(loading ||
        ...
        isStatusChanging ||
        isSubmitting ||
        generatingProfileId !== null) && <Loader local />}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="p-3 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-xl shadow-md">
              <Cable size={21} className="text-white" />
            </div>
            <div>
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          if (data?.url) {
                            ...
                            alert(
                              t("admin.mainWorkflow.alerts.urlGenerationFail")
                            );
                          }
                        } catch {
                          alert(
